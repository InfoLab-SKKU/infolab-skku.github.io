...
links:
   ...
   email: mazenelfayoumy@gmail.com
   
---

Mazen ElFayoumi is an AI Engineer and Data Scientist specializing in Large Language Models (LLMs), Retrieval-Augmented Generation (RAG), and AI-powered applications. He holds a Bachelor's degree in Computer Science (Artificial Intelligence Science Program) from Galala University, Egypt.  
...
- **Knowledge-Augmented LLM-Based Chatbot for Explainable Diabetes Mellitus Prediction** (IMCOM 2025)  
